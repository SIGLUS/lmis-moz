...
('CUSTOMER_RETURN', 'Returns from Customers(HF and dependent wards)', 'FALSE'),
('EXPIRED_RETURN_FROM_CUSTOMER', 'Returns of expired drugs (HF and dependent wards)', 'FALSE'),
('DONATION', 'Donations to Deposit', 'FALSE'),
('LOANS_RECEIVED', 'Loans received at the health facility deposit', 'FALSE'),
('RETURN_FROM_QUARANTINE', '"Returns from Quarantine', ' in the case of quarantined product being fit for use"', 'FALSE'),
('INVENTORY', 'Inventory', 'TRUE'),
('INVENTORY_NEGATIVE', 'Inventory correction in case of over stock on Stock  card (Stock on  hand is less than stock in stock card)', 'FALSE'),
('INVENTORY_POSITIVE', 'Inventory correction in case of under stock on Stock card (Stock on hand is more than stock in stock card)', 'TRUE'),
