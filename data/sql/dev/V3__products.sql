...
(code, primaryName, dispensingUnit, dosesPerDispensingUnit, packSize, active, fullSupply, tracer,
  packRoundingThreshold, roundToZero, strength, formId) values
...
('08S42', 'Lamivudina 150mg/Zidovudina 300mg/Nevirapina 200mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S18Y', 'Tenofovir 300mg/Lamivudina 300mg/Efavirenze 600mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S40', 'Lamivudina 150mg/ Zidovudina 300mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S36', 'Lamivudina 150mg/Stavudina 30mg/Nevirapina 200mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S32', 'Lamivudina 150mg/Stavudina 30mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S18Z', 'Tenofovir 300mg/Lamivudina 300mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S39Z', 'Lopinavir/Ritonavir 200mg/50mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S21', 'Efavirenze (EFV) 600mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S01', 'Abacavir (ABC) 300 mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S22', 'Nevirapina (NVP) 200mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S13', 'Lamivudina (3TC) 150mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S15', 'Zidovudina (AZT) 300mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S34B', 'Lamivudina 30mg/Stavudina 6mg/Nevirapina 50mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S32Z', 'Estavudina/Lamivudina 6mg+30mg, 60 Comp (Baby) Embalagem', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S42B', 'Lamivudina 30mg/Zidovudina 60mg/Nevirapina 50mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S40Z', 'Lamivudina 30mg/ Zidovudina 60mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S39B', 'Lopinavir/Ritonavir 100mg/25mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S39Y', 'Lopinavir/Ritonavir 80/20 ml Solução Oral', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Solution')),
('08S01ZZ', 'Abacavir 60mg/ Lamivudina 30mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S20', 'Efavirenze (EFV) 200mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S19', 'Efavirenze (EFV) 50mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S01B', 'Abacavir (ABC) 60mg', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Embalagem')),
('08S23', 'Nevirapina 50mg/5ml Sol Oral', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Suspension')),
('08S17', 'Zidovudina 50mg/5ml Sol Oral', 'Strip', 10, 10, TRUE, TRUE, FALSE, 1, FALSE, '10mg', (SELECT id from product_forms where code='Solution'));
