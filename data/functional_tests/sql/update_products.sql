...
((SELECT id FROM programs WHERE code = 'ESS_MEDS'), (SELECT id FROM products WHERE code = '99X99'), TRUE, TRUE,12.5, (SELECT id FROM product_categories where code = '12'), 0.0,  14);
