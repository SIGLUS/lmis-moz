...
((SELECT id FROM facilities WHERE code = 'HF1'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF1'), (SELECT id FROM programs WHERE code = 'ESS_MEDS'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF2'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
...
((SELECT id FROM facilities WHERE code = 'HF3'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
...
((SELECT id FROM facilities WHERE code = 'HF4'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF4'), (SELECT id FROM programs WHERE code = 'ESS_MEDS'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF5'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
...
((SELECT id FROM facilities WHERE code = 'HF6'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF6'), (SELECT id FROM programs WHERE code = 'ESS_MEDS'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF7'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF7'), (SELECT id FROM programs WHERE code = 'ESS_MEDS'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF8'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF8'), (SELECT id FROM programs WHERE code = 'ESS_MEDS'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF9'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'HF9'), (SELECT id FROM programs WHERE code = 'ESS_MEDS'),TRUE,'9/21/2013'),
((SELECT id FROM facilities WHERE code = 'F_VIA'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
...
((SELECT id FROM facilities WHERE code = 'F_STOCKCARD'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
...
((SELECT id FROM facilities WHERE code = 'F_PHYSICAL_INVENTORY'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
...
((SELECT id FROM facilities WHERE code = 'F_INITIAL_INVENTORY'), (SELECT id FROM programs WHERE code = 'VIA'),TRUE,'9/21/2013'),
